...
import { useGetAllOrdersQuery, useGetAverageRatingQuery, useGetAllProductsCountQuery } from '@/graphql/generated/output'
  ...
  return (
    <div className="max-w-[1640px] mx-auto px-[16px]">
      ...
      <div className="flex flex-col gap-[46px]">
        <div className="flex justify-center gap-[20px] sm:justify-between items-center flex-col md:flex-row">
